...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter
{
    ...
    protected void configure(HttpSecurity http) throws Exception
    {
        http.csrf().disable()
                ...
                .antMatchers(HttpMethod.DELETE,"/company/**","/skill/**").hasRole(Role.ADMIN)
                .antMatchers(HttpMethod.PUT,"/company/**","/skill/**").hasRole(Role.ADMIN)
                .antMatchers(HttpMethod.POST,"/company/**","/skill/**").hasRole(Role.ADMIN)
