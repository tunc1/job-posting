...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter
{
    ...
    protected void configure(HttpSecurity http) throws Exception
    {
        http.csrf().disable()
                ...
                .antMatchers(HttpMethod.POST,"/member/*/language","/member/*/education").hasRole(Role.MEMBER)
                .antMatchers(HttpMethod.PUT,"/member/*/language/*","/member/*/education/*").hasRole(Role.MEMBER)
                .antMatchers(HttpMethod.DELETE,"/member/*/language/*","/member/*/education/*").hasRole(Role.MEMBER)
