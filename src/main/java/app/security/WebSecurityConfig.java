...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter
{
    ...
    protected void configure(HttpSecurity http) throws Exception
    {
        http.csrf().disable()
                ...
                .antMatchers(HttpMethod.POST,"/member/*/language").hasRole(Role.MEMBER)
                .antMatchers(HttpMethod.PUT,"/member/*/language/*").hasRole(Role.MEMBER)
                .antMatchers(HttpMethod.DELETE,"/member/*/language/*").hasRole(Role.MEMBER)
